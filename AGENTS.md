...
| **字段权限设计资产** | `docs/permissions/Field_Level_Permission_Architecture_and_Implementation.md` | 字段三态控制、物理剥离、安全导出与组件拦截实战 |
...
| **业务切片开发技能** | `.agents/skills/erp-feature-dev/` | 涵盖数据建模、权限契约、安全Action、UI交互与路由的切片开发标准 |
