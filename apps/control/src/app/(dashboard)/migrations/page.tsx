...
import { MigrationsView } from "@platform/control-admin/migration-management";
import { getMigrationDashboardQuery } from "@platform/control-admin/migration-management/server";
