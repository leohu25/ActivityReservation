 ...
 * 遵循 ADR-006：将注册表生成在应用装配层 apps/tenant/src/assembly/registry.generated.ts，
 * 由顶层应用作为装配者 (Assembler) 集中挂载，彻底解除底层基础设施包反向依赖业务切片。
 */
...
const targetDir = path.resolve(rootDir, "apps/tenant/src/assembly");
...
function generateRegistryCode(features) {
  ...
  return `// @generated by apps/tenant/scripts/sync-features.mjs - DO NOT EDIT MANUALLY
/**
 * 全局租户自描述特性注册表（编译期自动发现生成）
 * 遵循 ADR-006：集中在应用装配层 (apps/tenant/src/assembly/)，消除底层包反向依赖。
 */
${imports.join("\n")}
