...
export interface TenantMaterialContext extends TenantDbContext {
  readonly ability: AppPrismaAbility<string, string>;
}

export async function getTenantMaterialContext(): Promise<TenantMaterialContext> {
