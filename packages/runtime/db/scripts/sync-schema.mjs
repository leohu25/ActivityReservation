...
function generateGeneratedHeader() {
	return `// @generated by packages/runtime/db/scripts/sync-schema.mjs - DO NOT EDIT MANUALLY
// Canonical aggregated schema for @runtime/core/db
generator client {
  provider = "prisma-client-js"
  output   = "../../../base/db-tenant/node_modules/@prisma/client-tenant"
}
