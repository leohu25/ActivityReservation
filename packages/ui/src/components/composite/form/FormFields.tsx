  ...
  return (
    <FormFieldGrid columns={columns} className={className}>
      {fields.map((field) => {
          ...
          return (
            <div
              ...
              className={cn(
                ...
                fieldError && "border-destructive/60 bg-destructive/5",
                spanClass,
              )}
            >
              <div className="flex min-w-0 flex-col gap-0.5">
                ...
                {fieldError ? (
                  <p data-slot="form-message" className="text-xs font-medium text-destructive mt-0.5">
                    {fieldError}
                  </p>
                ) : null}
              </div>
        ...
        return (
          <div key={field.name} className={cn("flex flex-col gap-1.5", spanClass)}>
            <div className="text-xs font-medium text-foreground">
              {field.label}
              {field.required ? (
                <span className="text-destructive ml-0.5">*</span>
  ...
  if (field.type === "select") {
    return (
      <Select
        ...
        disabled={field.disabled}
      >
        <SelectTrigger aria-invalid={isInvalid} className={cn("w-full", isInvalid && "border-destructive ring-destructive/20")}>
