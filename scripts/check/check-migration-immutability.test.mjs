...
test("findImmutableMigrationViolations - 基线重置合并历史时放行同Scope旧基线与旧迁移删除/重命名", () => {
	const changes = parseNameStatus(
		[
			"A\ttooling/db-migrate/baselines/tenant/20260918105431/baseline.sql",
			"A\ttooling/db-migrate/baselines/tenant/20260918105431/manifest.json",
			"A\ttooling/db-migrate/baselines/tenant/20260918105431/schema.prisma",
			"D\ttooling/db-migrate/baselines/tenant/20260917031400/baseline.sql",
			"D\ttooling/db-migrate/baselines/tenant/20260917031400/manifest.json",
			"D\ttooling/db-migrate/baselines/tenant/20260917031400/schema.prisma",
			"D\ttooling/db-migrate/migrations/tenant/old_step/migration.sql",
		].join("\n"),
	);
