...
import { resetLocalTenantDatabases } from "./runtime/local-reset";
...
@base/db-migrate
  ...
  db-migrate reset-tenant [--name <db_name>]
`);
}
...
async function main(): Promise<void> {
	...
	if (command === "reset-tenant") {
		...
		await resetLocalTenantDatabases(controlDatabaseUrl, {
			databaseName,
